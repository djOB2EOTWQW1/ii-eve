...
hl.bind("SHIFT + SUPER + mouse_up", function() zoomBy(1.2) end, { description = "Zoom: Zoom in" })
hl.bind("SHIFT + SUPER + mouse_down", function() zoomBy(0.5) end, { description = "Zoom: Zoom out" })
